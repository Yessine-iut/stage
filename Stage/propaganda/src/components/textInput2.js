...
function App() {
  ...
  function sendData() {
    ...
    let trait = document.getElementsByTagName("hr");
    for (let i = 0; i < trait.length; i++) {
      trait[i].style.display = "none";
    }
    if (!input.trim()) {
      data = " ";
      ...
      history.push("/PropagandaWordClouds2");
    } else {
      id++;
      axios
  ...
  return (
    <>
      ...
      >
        ...
        <Link to="/service2_1"></Link>
      </div>
      <div id="trait">
        <ColoredLine color="white"/>
      </div>
      <div
        style={{ backgroundColor: "#D9D9D9", width: "58%", marginLeft: "21%" }}
      >
        <div
          id="example"
          style={{
        ...
        >
          <div>
            <h3 style={{ marginLeft: "22%", marginTop: "20px" }}>
              Textual examples
            </h3>
            <h4
